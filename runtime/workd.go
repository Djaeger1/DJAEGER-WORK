...
func memBreakdown()map[string]int64{
 wanted:=map[string]bool{"MemTotal":true,"MemFree":true,"MemAvailable":true,"Buffers":true,"Cached":true,"SReclaimable":true,"Shmem":true,"SwapTotal":true,"SwapFree":true}
